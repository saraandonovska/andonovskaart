...
const translations = {
    ...
    mk: {
        ...
        "hero.intro": "Сликарството стана јазикот што го најдов пред да научам како да ги објаснам своите емоции. <br><br> Работам со акрил, јаглен и мешани медиуми за да преточам спомени, емоции и човечка поврзаност во визуелна форма. Секое дело е покана да застанеш, да набљудуваш и да почувствуваш.",
        ...
        "about.title": "За мене",
        "about.caption": "Уметницата зад платното, 2026",
        ...
        "about.facts.started.value": "штом можев да држам молив",
        ...
        "honors.title": "Признанија и награди",
        ...
        "honors.item4.text": "Добив стипендија за UX/UI+ Академијата (2023-2024) откако освоив прво место на групната изложба на Скала, проширувајќи ја мојата креативна пракса кон дигиталниот дизајн.",
        ...
        "contact.sub": "Нарачки, изложби, соработки — отворена сум за сѐ.",
        ...
        "exhibit.hero.lede2": "За мене, уметноста не се работи за давање одговори, туку за создавање простор за рефлексија - дијалог помеѓу себството и светот. „Импулс“ го претставува тој тивок, но моќен момент кога нешто длабоко почувствувано бара да биде видено, поканувајќи ги гледачите да се поврзат со сопствените емоции и толкувања.",
        ...
        "card1.back": "Од чадот се раѓа љубов што се смирува во нејзиниот ум. Чадот станува мост меѓу мислата и срцето, каде соништата и реалноста се стопуваат едно во друго. Нивните силуети остануваат кревки и минливи, како чувство што постои само помеѓу здивот и неговото исчезнување.",

        "card2.medium": "Комбиниран медиум, 2026",
        "card2.back": "Наместо знак на слабост, солзите стануваат украс - симбол на издржливост и постојаност. Од нашите најранливи моменти се раѓа нешто скапоцено и трајно. Скриените емоции ја трансформираат душата во одраз на безвременска убавина и љубов.",

        "card3.medium": "Комбиниран медиум, 2026",
        "card3.back": "Понекогаш најважните вистини не се гледаат, туку се слушаат одвнатре. Вниманието, нежноста и тивката рефлексија можат да создадат место на мир и светлина во најинтимните кутчиња на нас самите.",

        "card4.medium": "Акрил на платно, 2026",
        "card4.back": "Вечен внатрешен дијалог меѓу разумот и срцето. Нивното испреплетување открива дека токму тензијата меѓу спротивностите нè обликува. Едниот поглед е свртен кон светот, другиот навнатре - портрет на човечката состојба.",

        "card5.medium": "Акрил на платно, 2025",
        "card5.back": "Во моментот кога два врвови на прсти скоро се допираат, се раѓа светлина, потсетувајќи нè дека вистинската поврзаност не бара совршенство - таа бара само храброст да се приближиш. Допирот е повеќе од контакт; тоа е премин од темнина кон заедничка светлина.",

        "card6.medium": "Комбиниран медиум, 2024",
        "card6.back": "Силата и моќта веќе постојат во мене, и само јас можам да се ослободам себеси. Морам да поминам низ духовна трансформација, повторно да се поврзам со себе и да се разбудам одвнатре. Носењето на факелот на будењето не е лесно. Тоа започнува со учење да се сакам себеси, да се почувствувам жива повторно и да го видам сопствениот одраз низ нови очи.",
        ...
        "card8.back": "Во нашето постојано трагање по нешто подобро, честопати го заборавуваме нашето здравје. Дури кога ќе се соочиме со сериозна болест, почнуваме да ја гледаме технологијата како надеж. Напредокот на модерната медицина ни нуди втора шанса за живот. Преку иновации, ни се дава можност повторно да дишеме - здивот на едно ново утро.",

        "card9.medium": "Комбиниран медиум, 2023",
        "card9.back": "Тишина што избива одвнатре - крик кој не може да се чуе, но може длабоко да се почувствува. Лицето се бори да го задржи викот што гори под кожата, зафаќајќи го моментот кога срцето врика, а гласот останува тивок. Тоа ги одразува фрустрацијата и тагата што ги носиме внатре, невидливи и нечуени од светот.",

        "card10.medium": "Комбиниран медиум, 2026",
        "card10.back": "Момент кога универзумот се усогласува со копнежот на две души определени да се сретнат. Деликатен црвен конец ја осветлува темнината, поврзувајќи две силуети - невидлива сила која ги води едни кон други. Тоа е точката каде времето и судбината накратко се допираат.",
